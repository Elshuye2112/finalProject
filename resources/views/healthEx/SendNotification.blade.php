...
<h1>Welcome to send notification</h1>
<div class="container">
  <form action="">
    <label for="id">Id of the reciever</label>
    <input type="text" id="id" name="id" placeholder="Reciever id..">
    ...
    <input type="submit" value="send" c>
